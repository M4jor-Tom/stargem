...
Totals: **29 HTTP 200**, **2 HTTP 202**, **1 HTTP 404**, **1 HTTP 000**. Three of the HTTP-200 pages were navigation/search redirects or unproductive catalog discovery, not independent game facts. Exact URLs, dates and short evidence above are the durable record; temporary captures are not required to understand these findings.
